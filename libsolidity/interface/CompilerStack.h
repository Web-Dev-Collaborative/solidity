...
public:
	...
	/// @returns the Contract Metadata for the binary generated by the experimental IR codegen.
	std::string const& evmMetadata(std::string const& _contractName) const { return evmMetadata(contract(_contractName)); }

	/// @returns the Contract Metadata for the binary generated by the EVM codegen.
	std::string const& irMetadata(std::string const& _contractName) const { return irMetadata(contract(_contractName)); }
...
private:
	...
	struct Contract
	{
		...
		util::LazyInit<std::string const> evmMetadata; ///< The metadata json that will be hashed into the chain. For EVM codegen.
		util::LazyInit<std::string const> irMetadata; ///< The metadata json that will be hashed into the chain. For IR codegen.
	...
	/// @returns the Contract Metadata for the binary generated by the EVM codegen.
	/// This will generate the metadata and store it in the Contract object if it is not present yet.
	std::string const& evmMetadata(Contract const& _contract) const;

	/// @returns the Contract Metadata for the binary generated by the experimental IR codegen.
	/// This will generate the metadata and store it in the Contract object if it is not present yet.
	std::string const& irMetadata(Contract const& _contract) const;
